...
const inspections_controller_js_1 = require("./inspections.controller.js");
...
exports.InspectionsModule = InspectionsModule = __decorate([
    (0, common_1.Module)({
        controllers: [inspections_controller_js_1.InspectionsController],
        providers: [inspections_service_js_1.InspectionsService],
        exports: [inspections_service_js_1.InspectionsService],
    })
], InspectionsModule);
