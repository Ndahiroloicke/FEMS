...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Authenticate and receive an access token' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Logout (stateless acknowledgement)' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Reset password using a valid token' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
