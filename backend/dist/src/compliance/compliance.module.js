...
const compliance_controller_js_1 = require("./compliance.controller.js");
...
exports.ComplianceModule = ComplianceModule = __decorate([
    (0, common_1.Module)({
        controllers: [compliance_controller_js_1.ComplianceController],
        providers: [compliance_service_js_1.ComplianceService],
        exports: [compliance_service_js_1.ComplianceService],
    })
], ComplianceModule);
